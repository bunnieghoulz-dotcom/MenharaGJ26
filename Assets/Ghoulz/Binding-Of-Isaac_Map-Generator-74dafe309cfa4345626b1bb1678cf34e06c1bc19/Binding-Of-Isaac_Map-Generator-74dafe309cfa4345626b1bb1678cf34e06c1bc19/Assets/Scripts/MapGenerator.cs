...
{
    [SerializedField] private int[] floorPlan;
    ...
    [SerializedField] private Sprite spawn;
    ...
    void Update()
    {
        // on spacebar new room is genereated
    ...
    {
        //loop to destroy pre existing cells and reinitialize values
